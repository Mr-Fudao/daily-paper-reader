...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-25 19:51:36 UTC<br>状态：成功</p>
</section>
...
<p>今日仅速读1篇论文，聚焦金融AI系统的证据检索与推理基准；</p>
<p>最值得关注的是《FinRCA-Bench》提出的金融领域评测方向，虽评分6.0但具参考价值；</p>
<p>建议后续可精读该文，或搜索同类金融RAG基准做对比。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="FinRCA-Bench: Benchmarking Evidence Retrieval and Reasoning for Financial AI Systems">FinRCA-Bench: Benchmarking Evidence Retrieval and Reasoning for Financial AI Systems</span></li></ul>
  </div>
