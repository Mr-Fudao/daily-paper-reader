...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-29 21:10:12 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇因果推断论文，聚焦政策评估中的内生选择与溢出效应问题。最值得关注的是该研究提出贝叶斯方法处理复杂干扰，8.0分高价值。建议普通读者重点关注其“政策相关因果效应”的识别思路，可迁移至实际决策场景。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Endogenous Selection and Spillovers: Bayesian Inference for Policy-Relevant Causal Effects">Endogenous Selection and Spillovers: Bayesian Inference for Policy-Relevant Causal Effects</span></li></ul>
  </div>
