...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-13 20:34:34 UTC<br>状态：成功</p>
</section>
...
<p>今日速读2篇论文，覆盖金融预测归因与采购文本NLP检测，未安排精读。</p>
<p>最高分7.0分论文将预测差异归因至输入变化，直指CCAR/CECL压力测试场景，值得优先关注。</p>
<p>建议下一步精读该高分论文，评估其归因方法能否迁移到自身预测流程。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Attributing Differences Between Forecast Runs to Input Changes, With Applications to CCAR and CECL Exercises">Attributing Differences Between Forecast Runs to Input Changes, With Applications to CCAR and CECL Exercises</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Cascaded Unsupervised-Supervised NLP Pipeline for Detecting Accusatory Language in Public Procurement">A Cascaded Unsupervised-Supervised NLP Pipeline for Detecting Accusatory Language in Public Procurement</span></li></ul>
  </div>
