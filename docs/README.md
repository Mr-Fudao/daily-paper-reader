...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-04 22:35:13 UTC<br>状态：成功</p>
</section>
...
<p>今日仅速读1篇论文，暂无精读；聚焦双重差分法中州级处理效应的估计与推断。</p>
<p>值得关注：该文探讨“哪种政策在何处有效”，针对州级异质性处理效应提供估计与检验方法，对政策评估研究有参考价值。</p>
<p>建议普通读者不必细读，若关注政策因果推断方法，可待精读后再深入。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Which Policy Works, and Where? Estimation and Inference for State-Level Treatment Effects in Difference-in-Differences">Which Policy Works, and Where? Estimation and Inference for State-Level Treatment Effects in Difference-in-Differences</span></li></ul>
  </div>
