...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-01 22:28:52 UTC<br>状态：成功</p>
</section>
...
<p>今日仅速读1篇临床预测AI论文，无精读。</p>
<p>值得关注：该文探讨性能指标的可折叠性，对模型评估有启发。</p>
<p>建议下一步可精读此文，或补充相关评估方法对比。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Collapsibility of Performance Metrics in Clinical Predictive AI">Collapsibility of Performance Metrics in Clinical Predictive AI</span></li></ul>
  </div>
